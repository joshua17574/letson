...
const PAGE_RULES: PageRule[] = [ { prefix: "/profit/chicken-slicing", permission: "reports.profit" }, { prefix: "/reports/chicken-slicing", permission: "reports.profit" },
  ...
  // Your app has this route but it is not currently in your nav permission list.
  // I mapped it to reports.profit for now because expenses affect profit.
  // Change this later if you add expenses-bodega.view / expenses-bodega.manage.
...
export async function middleware(request: NextRequest) {
  ...
  const permissions = Array.isArray((token as any).permissions)
